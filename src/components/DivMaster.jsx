        ...
        <div className='DivMaster'>
            <div>
                ...
                <div className='DivBotao'>
                    <div>
                        <button type="button" className='Button' id='calcular' onClick={calcularImc}><strong>Calular</strong></button>
                    </div>
                    <div>
                        <button type="button" className='Button' id='limpar' onClick={limpar}><strong>Limpar</strong></button>
                    </div>
                </div>
